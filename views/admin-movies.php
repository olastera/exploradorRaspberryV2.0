...
<?php else: ?>
    <div class="movie-grid">
        <?php foreach ($directories as $dir):
            ...
            $dirFileCount = \App\Media\FileExplorer::countFiles($targetPath . DIRECTORY_SEPARATOR . $dir);
        ?>
        <div class="movie-card explorer-item position-relative" data-name="<?php echo htmlspecialchars($dir, ENT_QUOTES); ?>" data-type="folder">
            ...
            <div class="movie-card-body">
                ...
                <div class="subtitle mb-2">Carpeta · <?php echo $dirFileCount; ?> <?php echo $dirFileCount === 1 ? 'arxiu' : 'arxius'; ?></div>
